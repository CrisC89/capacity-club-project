...
// ! application Layer
  ...
  serviceLocator.registerFactory<HomePageBloc>(() => HomePageBloc(
      ...
      getIndividualIndoorTrainingListByDate: serviceLocator()));
...
// ! domain Layer
  ...
  serviceLocator.registerFactory<GetCollectiveIndoorTrainingListByDate>(() =>
      GetCollectiveIndoorTrainingListByDate(
          indoorTrainingRepository: serviceLocator()));

  serviceLocator.registerFactory<GetIndividualIndoorTrainingListByDate>(() =>
