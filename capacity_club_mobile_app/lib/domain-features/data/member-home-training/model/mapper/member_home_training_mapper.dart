...
class MemberHomeTrainingMapper {
  static MemberHomeTrainingModel fromEntity(MemberHomeTrainingEntity entity) {
  ...
  static MemberHomeTrainingModel fromJson(Map<String, dynamic> json) {
    return MemberHomeTrainingModel(
      ...
      home_training: json['home_training'] != null
          ...
          : null,
      member:
          json['member'] != null ? MemberMapper.fromJson(json['member']) : null,
    );
  }

  static MemberHomeTrainingEntity toEntity(MemberHomeTrainingModel model) {
  ...
  static Map<String, dynamic> toJson(MemberHomeTrainingModel model) {
    return {
      'member_home_training_id': model.member_home_training_id,
