...
class DateTimeLineWithYearSelector2 extends StatefulWidget {
  const DateTimeLineWithYearSelector2({super.key});

  @override
  _DateTimeLineWithYearSelectorState2 createState() =>
      _DateTimeLineWithYearSelectorState2();
}

class _DateTimeLineWithYearSelectorState2
    extends State<DateTimeLineWithYearSelector2> {
