import 'package:capacity_club_mobile_app/domain-features/application/pages/home/components/widget/collective-training/collective_training_card.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:flutter/material.dart';

class CollectiveTrainingCarousel2 extends StatefulWidget {
  const CollectiveTrainingCarousel2({super.key});

  @override
  State<CollectiveTrainingCarousel2> createState() =>
      _CollectiveTrainingCarouselState2();
}

class _CollectiveTrainingCarouselState2
    extends State<CollectiveTrainingCarousel2> {
