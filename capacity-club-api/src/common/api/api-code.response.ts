...
export enum ApiCodeResponse {
  ...
  TRAINING_EXERCISE_NOT_FOUND = 'api.error.training-exercise-not-found',
  TRAINING_EXERCISE_DELETE_SUCCESS = 'api.success.training-exercise-delete',
  TRAINING_EXERCISE_UPDATE_ERROR = 'api.error.training-exercise-update',
  TRAINING_EXERCISE_UPDATE_SUCCESS = 'api.success.training-exercise-update',
  TRAINING_EXERCISE_DELETE_ERROR = 'api.error.training-exercise-delete',
  TRAINING_EXERCISE_LIST_ERROR = 'api.error.training-exercise-list',
  TRAINING_EXERCISE_LIST_SUCCESS = 'api.success.training-exercise-list',
  TRAINING_EXERCISE_CREATE_ERROR = 'api.error.training-exercise-create',
  TRAINING_EXERCISE_CREATE_SUCCESS = 'api.success.training-exercise-create',
